...
░  ░  ░   ░░░ ░ ░ ░░         ░   ▒     ░░   ░  ▒ ░        ░░    ░   ▒     ░ ░   ░ ░ ░ ▒  
 ...
 By Ripxtar """
    ...
    def ConfigUpdate():
        clear = lambda: os.system('cls')
        clear()
        utils.set_title("Supari Valo Checker ~ Settings")
...
░  ░  ░   ░░░ ░ ░ ░░         ░   ▒     ░░   ░  ▒ ░        ░░    ░   ▒     ░ ░   ░ ░ ░ ▒  
 ...
 By Ripxtar """
    ...
    def Menu():
        utils.set_title("Supari Valo Checker [By Ripxtar]~ Menu")
        clear()
        print(logo)
        print()
        print(f"{Icon} Hello Welcome to Supari Valo Checker!")
...
░  ░  ░   ░░░ ░ ░ ░░         ░   ▒     ░░   ░  ▒ ░        ░░    ░   ▒     ░ ░   ░ ░ ░ ▒  
 ...
 By Ripxtar  """
    ...
    def ScreenLOG():
        ...
        cmp1 = cpm
        cpm = 0
        windll.kernel32.SetConsoleTitleW(f" Supari Valo Checker - (By Ripxtar) | Checked: {checked}\{len(emails)} -  Good: {hits} - Bad: {fail} - Customs: {free} - Banned Accounts: {banned} - Cpm: {cmp1*60} - Retries: {retries} - Errors: {error} ")
        time.sleep(1)
    ...
    def ScreenCUI():
        ...
        print(logo)
        print()
        print(" Supari Valo Checker Running... [{}]".format(Fore.LIGHTMAGENTA_EX + str(ComboName) + Fore.LIGHTWHITE_EX))
    ...
    def Capture(AccessToken,User,Pass,sess):
        ...
        try:
            ...
            SaveHits.write(f"[--------------[Supari Valo Checker]--------------]\n| User&Pass: {User}:{Pass}\n| Region: {Region}\n| Level: {AccountLevel}\n| Email Verified: {EmailVerified}\n| Rank: {Rank}\n| VP: {ValorantPoints} - RP: {Radianite}\n|-------------[Skins({len(Skin)})]-------------]\n{SkinStr}[-------------------------------------]\n\n")
            SaveHits.close()
    ...
    def CheckerMenu():
        ...
        clear()
        windll.kernel32.SetConsoleTitleW("Supari Valo Checker - (By Ripxtar)")
        print(logo)
        print()
        print()
        try:
